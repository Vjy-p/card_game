...
class FourthCardBottomSheet extends StatefulWidget {
  const FourthCardBottomSheet({super.key, required this.cards});
  final List<PlayingCard> cards;

  @override
  State<FourthCardBottomSheet> createState() => _DeclareCardSheetState();
}

class _DeclareCardSheetState extends State<FourthCardBottomSheet> {
  late List<PlayingCard> availableCards;
  // Updated to hold PlayingCard objects instead of ints
  List<PlayingCard> cardSets = [];
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ActionButton(
                        onPressed: () {
                          final bool resp = controller.validate4thCards(
                            cards: cardSets,
                          );
                          if (resp) {
